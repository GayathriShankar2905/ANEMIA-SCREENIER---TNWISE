  ...
  Widget build(BuildContext context) => Container(
    ...
    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
        ...
        Icon(Icons.more_horiz, size: 16, color: const Color(0xFF3D5A7A)),
      ]),
      const SizedBox(height: 8),
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(children: [
        ...
        Icon(Icons.chevron_right_rounded, size: 18, color: const Color(0xFF3D5A7A)),
      ]));
  }
}
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final tp = TextPainter(
      text: TextSpan(text: '${(pct * 100).toStringAsFixed(0)}%',
        style: TextStyle(fontFamily: 'sans-serif', fontSize: 26,
          fontWeight: FontWeight.w900, color: const Color(0xFFF0F8FF))),
      textDirection: TextDirection.ltr)..layout();
    tp.paint(canvas, Offset(cx - tp.width/2, cy + 6));

    final lp = TextPainter(
      text: TextSpan(text: 'RISK',
        style: const TextStyle(fontFamily: 'sans-serif', fontSize: 9,
